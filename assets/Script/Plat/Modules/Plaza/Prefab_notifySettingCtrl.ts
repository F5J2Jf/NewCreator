...
export default class Prefab_notifySettingCtrl extends BaseControl {
	...
	connectUi()
	{
		this.connect(G_UiType.toggle, this.ui.node_MatchAd, this.switchCB, '大奖赛广告开关');
		this.connect(G_UiType.toggle, this.ui.node_MatchBegin, this.switchCB, '比赛开始提示开关');
		this.connect(G_UiType.toggle, this.ui.node_ClubMatchSignUp, this.switchCB, '俱乐部赛报名提示开关');
		this.connect(G_UiType.toggle, this.ui.node_ClubMatchInvite, this.switchCB, '俱乐部赛邀请开关');
	}
