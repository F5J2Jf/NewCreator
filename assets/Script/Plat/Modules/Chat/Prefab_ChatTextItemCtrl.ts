...
let ctrl : Prefab_ChatTextItemCtrl;
//模型，数据处理
...
//c, 控制
@ccclass
export default class Prefab_ChatTextItemCtrl extends BaseControl {
	//这边去声明ui组件
	@property({
		tooltip : "聊天文本",
		type : cc.Label
	...
	//end
	//按钮或任何控件操作的回调begin
	private _onClick_Selected (event) : void {
