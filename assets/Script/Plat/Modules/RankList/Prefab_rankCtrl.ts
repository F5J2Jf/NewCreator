...
class View extends BaseView{
	...
	initUi()
	{
		...
		this.ui.node_TopFrame = ctrl.node_rankView.parent;
	...
	public enterRankAction(){
		this.ui.node_sprite_all.x = -1000;
		this.ui.node_TopFrame.pauseSystemEvents(true);
		var moveBy = cc.moveBy(0.3, cc.p(1000, 0));
		var callback = cc.callFunc(()=>{
			this.ui.node_TopFrame.resumeSystemEvents(true);
		});
	...
	public setRankHeight(count){
		let curNode:cc.Node = cc.instantiate(this.ui.player_data);
		this.ui.node_rankList.height = count * (curNode.height + this.model.getRankListGap());
	}
	public clearRankList(){
		this.ui.node_rankList.removeAllChildren();
