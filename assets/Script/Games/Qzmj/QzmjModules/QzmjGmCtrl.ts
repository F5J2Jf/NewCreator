...
//c, 控制
@ccclass
export default class QzmjGmCtrl extends BaseCtrl {
	//这边去声明ui组件
	@property({
		tooltip : "我方的麻将位置",
		type : cc.Node
	...
	emitChangeCard () : void {
		if (this.model.handCard != null && this.model.oppositeCard != null) {
			...
			// let s = new cc.SpriteFrame(QzmjResMgr.getInstance().getCardTextureByValue(this.model.oppositeCard));
